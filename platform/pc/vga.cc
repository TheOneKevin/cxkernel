...
namespace pc::vga
{
    ...
    void scroll(void)
    {
        ...
        auto* terminal_buffer = (uint16_t*) ARCH_GET_PHYS(VGA_FRAME_BASE); // We need to cast this.
    ...
    void clear(uint8_t bg)
    {
        ...
        bg_color = bg;
        auto* terminal_buffer = (uint16_t*) ARCH_GET_PHYS(VGA_FRAME_BASE); // Cast the void pointer
    ...
    void putc(const char c)
    {
        ...
        auto* terminal_buffer = (uint16_t*) ARCH_GET_PHYS(VGA_FRAME_BASE);
