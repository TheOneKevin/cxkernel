...
#include "lib/printk.h" // fprintf, kprinf
...
{
    if (remote_debug)
        fprintf(STREAM_ERR, format, parm);
}
 ...
 */
char *mem2hex(char *mem, char *buf, int count, bool may_fault)
{
    int i;
    unsigned char ch;
    if (may_fault)
...
void handle_exception(int exceptionVector)
{
    ...
    *ptr++ = hexchars[EBP];
    *ptr++ = ':';
    ptr = mem2hex((char *)&registers[EBP], ptr, 4, 0); // BP
    *ptr++ = ';';
    *ptr++ = hexchars[PC];
    *ptr++ = ':';
    ptr = mem2hex((char *)&registers[PC], ptr, 4, 0); // PC / EIP
    *ptr++ = ';';
    *ptr = '\0';
...
void initialize_debugger(void)
{
    ...
    exceptionHandler(1, (unsigned int) _catchException1);
    exceptionHandler(3, (unsigned int) _catchException3);
    exceptionHandler(4, (unsigned int) _catchException4);
    exceptionHandler(5, (unsigned int) _catchException5);
    exceptionHandler(6, (unsigned int) _catchException6);
    exceptionHandler(7, (unsigned int) _catchException7);
    exceptionHandler(8, (unsigned int) _catchException8);
    exceptionHandler(9, (unsigned int) _catchException9);
    exceptionHandler(10, (unsigned int) _catchException10);
    exceptionHandler(11, (unsigned int) _catchException11);
    exceptionHandler(12, (unsigned int) _catchException12);
    exceptionHandler(13, (unsigned int) _catchException13);
    exceptionHandler(14, (unsigned int) _catchException14);
    exceptionHandler(16, (unsigned int) _catchException16);
    initialized = 1;
    breakpoint();
}
