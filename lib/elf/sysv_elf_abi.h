// ref: http://www.sco.com/developers/gabi/latest/contents.html for ABI specs.
...
#define ET_HIPROC 0xffff   //!< Processor-specific
   ...
   elf32_half_t e_machine; //!< This member's value specifies the required architecture for an
                           //!< individual file.
...
#define ELFCOMPRESS_ZLIB 1
   ...
   elf32_word_t
         ch_size; //!< This member provides the size in bytes of the uncompressed data. See sh_size.
   elf32_word_t ch_addralign; //!< Specifies the required alignment for the uncompressed data. See
                              //!< sh_addralign.
} elf32_chdr_t;
