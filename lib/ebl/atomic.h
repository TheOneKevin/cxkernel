...
namespace ebl {
   ...
   public:
      ...
      bool compare_exchange_weak(T& expc,
                                 T desr,
                                 memory_order s,
      ...
      bool compare_exchange_strong(T& expc,
                                   T desr,
                                   memory_order s,
                                   memory_order f) volatile noexcept {
   ...
   inline void atomic_thread_fence(memory_order m) noexcept { __atomic_thread_fence(m); }

   inline void atomic_signal_fence(memory_order m) noexcept { __atomic_signal_fence(m); }
} // namespace ebl
