...
#define NL "\n"
      asm volatile("lock bts $0, (%0)" NL "jnc 2f" NL "1:" NL "pause" NL "testl $1, (%0)" NL
                   "jne 1b" NL "lock bts $0, (%0)" NL "jc 1b" NL "2:"
                   :
                   : "r"(lock->x)
                   : "memory");
#undef NL
   ...
   inline void spin_unlock(SpinlockBackend* lock) { lock->x = 0; }

   inline void enable_interrupts() { x86_64::sti(); }

   inline void disable_interrupts() { x86_64::cli(); }
   ...
   inline int cpu_num() { return (int)x86_64::read_gs_offset64(offsetof(PerCPU, cpu_num)); }

   inline PerCPU* get_percpu() { return (PerCPU*)x86_64::read_gs_offset64(offsetof(PerCPU, self)); }

   inline core::Thread* get_current_thread() { return get_percpu()->curthread; }
